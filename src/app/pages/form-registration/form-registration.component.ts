...
export class FormRegistrationComponent {
  ...
  constructor(private fb: FormBuilder, private usersService: UsersService, private router: Router) {
    this.registerForm = this.fb.group({
      name: ['Mariana Roca', Validators.required],
      username: ['marianar', Validators.required],
      email: ['marianar@guirre.com', [Validators.required, Validators.email, this.emailDomainValidator]],
      password: ['', Validators.required],
      repite_password: ['', Validators.required],
      role: ['', Validators.required],
      date_of_birth: ['1965-09-02', Validators.required],
      phone: ['695214589', Validators.required],
      image: [''],
